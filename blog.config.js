...
const BLOG = {
  ...
  POST_WAITING_TIME_FOR_404:
    process.env.NEXT_PUBLIC_POST_WAITING_TIME_FOR_404 || '300', // 文章加载超时时间，单位秒；超时后跳转到404页面
  ...
  TianliGPT_KEY: process.env.NEXT_PUBLIC_TIANLI_GPT_KEY || 'sk-vnKCpc4SXbNb1WnYyJfEFpzFuxgikiQc2gytqHroXtE8V4FX',
